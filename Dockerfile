...
RUN sudo apt-get update && \
    ...
    sudo mkdir -p /snap/core && sudo unsquashfs -d /snap/core/current core.snap && rm core.snap && \
    ...
    sudo mkdir -p /snap/snapcraft && sudo unsquashfs -d /snap/snapcraft/current snapcraft.snap && rm snapcraft.snap && \
